...
import getcat from "../../utils/cat.js";

export default function Term() {
  const cmds = commands.commands;
  const owrs = commands.overwrites;
  const terminal = React.createRef();
  const [prompt, setPrompt] = React.useState("you@/jimmy:~$ ");
  ...
  return (
    <Terminal
      ...
      promptLabelStyle={{ color: "#00FF41", fontWeight: "normal" }} // Prompt label colour
      inputTextStyle={{ color: "#e95420", fontWeight: "normal" }}
      messageStyle={{
        color: "#e95420",
        fontWeight: "normal",
        paddingLeft: null,
