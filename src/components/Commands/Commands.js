...
export default {
  commands: {
    ...
    twitter: {
      ...
      usage: "twitter",
      fn: () => {
        window.open("https://twitter.com/franklatack", "_blank");
    ...
    github: {
      ...
      usage: "twitter",
      fn: () => {
        window.open("https://github.com/jimmy-steve", "_blank");
    ...
    discord: {
      ...
      usage: "twitter",
      fn: () => {
        window.open("https://discordapp.com/users/jimmysteve0243", "_blank");
